...
object build extends Build {
  ...
  lazy val dependenciesSettings: Seq[Settings] = Seq(
    libraryDependencies <<= (version, scalaVersion) { (version, scalaVersion) =>
      ...
      "org.scalaz"               %% "scalaz-concurrent"         % "7.0.0-RC2",
      "org.scalaz"               %% "scalaz-scalacheck-binding" % "7.0.0-RC2"        intransitive(),
      "org.scalaz"               %% "scalaz-typelevel"          % "7.0.0-RC2"        intransitive(),
      "org.scalaz"               %% "scalaz-xml"                % "7.0.0-RC2"        intransitive(),
  ...
  lazy val publishForCDH3 = ReleaseStep { st: State =>
    ...
    "git cherry-pick -n 4c35d8c" !! st.log
